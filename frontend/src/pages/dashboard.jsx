...
function Dashboard() {
  ...
  async function handleSearch(e) {
    ...
    if (query === "old=1" || query === "new=1") {
      ...
      try {
        let res = await fetch(
          `https://library-app-1-26pr.onrender.com/library/books?${query}`,
          {
            method: "GET",
            headers: {
  ...
  async function getBooks() {
    try {
      const res = await fetch(
        "https://library-app-1-26pr.onrender.com/library/books",
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    <>
      ...
      <Flex height="100vh">
        ...
        <Box flex="1" p={6}>
          ...
          <Input
            type="text"
            placeholder="Search your query eg: new=1 ,old=1 "
                ...
                <Link to={`/displayBook/${ele._id}`}>
                  ...
                  <VStack spacing={2} align="start">
                    ...
                    <Text fontSize="sm" color="gray.500">
                      {ele.publisher} pages | {ele.language}
                    </Text>
                  </VStack>
                </Link>
              </Box>
